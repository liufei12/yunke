...
func RegisterTagServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TagServiceServer) error {
	...
	mux.Handle("GET", pattern_TagService_GetTagList_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_TagService_GetTagList_0(rctx, inboundMarshaler, server, req, pathParams)
...
var (
	pattern_TagService_GetTagList_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "tags"}, "", runtime.AssumeColonVerbOpt(true)))
)
